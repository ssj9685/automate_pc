...
class Gesture:
    ...
    def __init__(self):
        self.x = 100
        self.model = load_model(os.getcwd()+"/model_1.h5")
        self.y = 100
        self.size = 200
        self.color = (0, 255, 0)
        self.thick = 1
    ...
    def calfinger(self, thresh):
        modelInput = cv2.resize(thresh, (28, 28))
        modelInput = np.expand_dims(modelInput, -1)
        modelInput = np.expand_dims(modelInput, 0)
    ...
    def main(self):
        ...
        while True:
            ...
            if(contours):
                ...
                count_defects = self.calfinger(thresh)
